...
const JpegCompress = () => {
  ...
  const compressImage = async () => {
    if (!file) {
      toast({
        title: "Fehler",
        description: "Bitte wählen Sie ein JPEG-Bild aus.",
        variant: "destructive"
      });
      return;
    }
    ...
    try {
      ...
      toast({
        title: "Erfolgreich",
        description: "JPEG-Bild wurde erfolgreich komprimiert!"
      });
    } catch (error) {
      console.error('Error compressing image:', error);
      toast({
        title: "Fehler",
        description: "Fehler beim Komprimieren des JPEG-Bildes.",
        variant: "destructive"
      });
    } finally {
      setIsProcessing(false);
  ...
  return (
    <>
      <Helmet>
        <title>JPEG komprimieren online – kostenlos & sicher | Toolbox24</title>
        <meta name="description" content="JPEG-Bilder kostenlos online komprimieren. Reduzieren Sie die Dateigröße Ihrer JPG-Dateien schnell und sicher in Ihrem Browser." />
      </Helmet>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <Button
                    ...
                    className="w-full"
                  >
                    {isProcessing ? 'Komprimierung...' : 'JPEG komprimieren'}
                  </Button>
                </div>
              </div>
            )}
            ...
            {downloadUrl && (
              <div className="text-center p-6 bg-muted/50 rounded-lg border">
                ...
                >
                  ...
                  Komprimiertes JPEG herunterladen
                </Button>
              </div>
            )}
          </div>
          ...
          <div className="mt-12 p-6 bg-muted/30 rounded-lg">
            ...
            <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
              <li>Wählen Sie ein JPEG-Bild aus (bis zu 50MB)</li>
              <li>Stellen Sie die gewünschte Qualität ein</li>
              <li>Klicken Sie auf "JPEG komprimieren"</li>
            ...
            <p className="text-sm text-muted-foreground mt-4">
              ...
              Ihre JPEG-Bilder werden nicht an externe Server übertragen.
            </p>
          </div>
        </div>
      </div>
