...
const PngCompress = () => {
  ...
  const compressImage = async () => {
    if (!file) {
      toast({
        title: "Fehler",
        description: "Bitte wählen Sie ein PNG-Bild aus.",
        variant: "destructive"
      });
      return;
    }
    ...
    try {
      ...
      toast({
        title: "Erfolgreich",
        description: "PNG-Bild wurde erfolgreich komprimiert!"
      });
    } catch (error) {
      console.error('Error compressing image:', error);
      toast({
        title: "Fehler",
        description: "Fehler beim Komprimieren des PNG-Bildes.",
        variant: "destructive"
      });
    } finally {
      setIsProcessing(false);
        ...
        <div className="container mx-auto px-4 max-w-4xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <Button
                    ...
                    className="w-full"
                  >
                    {isProcessing ? 'Komprimierung...' : 'PNG komprimieren'}
                  </Button>
                </div>
              </div>
            )}
            ...
            {downloadUrl && (
              <div className="text-center p-6 bg-muted/50 rounded-lg border">
                ...
                >
                  ...
                  Komprimiertes PNG herunterladen
                </Button>
              </div>
            )}
          </div>
          ...
          <div className="mt-12 p-6 bg-muted/30 rounded-lg">
            ...
            <ol className="list-decimal list-inside space-y-2 text-muted-foreground">
              <li>Wählen Sie ein PNG-Bild aus (bis zu 50MB)</li>
              <li>Stellen Sie die gewünschte Qualität ein</li>
              <li>Klicken Sie auf "PNG komprimieren"</li>
            ...
            <p className="text-sm text-muted-foreground mt-4">
              ...
              Ihre PNG-Bilder werden nicht an externe Server übertragen.
            </p>
          </div>
        </div>
      </div>
